...
function NAUTES_SoundVisualizer(CONFIG) {
	...
	if (!navigator.mediaDevices) {
		...
		STR_HTML += '<tr>';
		STR_HTML += '<th>';
		STR_HTML += '<b>Web Audio 기능을 지원하지 않는 바보 같은 구식 웹브라우저를 아직도 사용하고 계십니까?</b><br/><br/>';
		STR_HTML += 'Chrome, Edge 등의 웹브라우저로 접속하셔야 (실시간) 통화 내용을 청취할 수 있습니다.';
		STR_HTML += '</th>';
		STR_HTML += '</tr>';
		STR_HTML += '</table>';
	...
	STR_HTML += '<div style="width:100%; height:15%; padding:0px; text-align:left;">';
		...
		STR_HTML += '</div>';
		STR_HTML += '<div class="btn-group">';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_ZOOM_IN"		title="파형 확대" class="BTN_NAUTES_WAE btn-zoom-in btn btn-default"><i class="fa fa-search-plus"></i></span>';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_ZOOM_OUT"	title="파형 축소" class="BTN_NAUTES_WAE btn-zoom-out btn btn-default"><i class="fa fa-search-minus"></i></span>';
		STR_HTML += '</div>';
		STR_HTML += '<div class="btn-group btn-playlist-state-group">';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_MODE_CURSOR"	class="BTN_NAUTES_WAE btn-cursor btn btn-default active" title="위치 지정"><i class="fa fa-headphones"></i></span>';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_MODE_SELECT"	class="BTN_NAUTES_WAE btn-select btn btn-default" title="영역 지정"><i class="fa fa-italic"></i></span>';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_MODE_SHIFT"	class="BTN_NAUTES_WAE btn-shift  btn btn-default" title="좌우 이동"><i class="fa fa-arrows-h"></i></span>';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_MODE_DELETE"	class="BTN_NAUTES_WAE btn-trash  btn btn-default" title="트랙 삭제"><i class="fa fa-trash-o"></i></span>';
		STR_HTML += '</div>';
		STR_HTML += '<div class="btn-group btn-select-state-group">';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_TOGGLE_LOOP"	class="BTN_NAUTES_WAE btn-loop btn btn-default"		title="선택 영역 반복 재생">';
				STR_HTML += '<i class="fa fa-repeat"></i>';
			STR_HTML += '</span>';
		STR_HTML += '</div>';
		STR_HTML += '<div class="btn-group">';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_SLICE"	class="BTN_NAUTES_WAE btn-trim-audio btn btn-primary"	title="선택 영역 조각화" >SLICE</span>';
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_CLEAR"	class="BTN_NAUTES_WAE btn btn-clear btn-danger" title="모든 오디오 트랙 지우기" >CLEAR</span>';
		STR_HTML += '</div>';
if (CONFIG.DOWNLOAD_DISABLE) {
		STR_HTML += '<div class="btn-group hidden">';
} else {
		STR_HTML += '<div class="btn-group">';
}
			STR_HTML += '<span id="BTN_NAUTES_WAE_EXEC_DOWNLOAD" title="WAV 파일로 다운로드 받기"';
	...
	$("#NAUTES_WAE_PLAY_SPEED").jqxSlider({
        ...
        height: 30,
        mode: 'fixed',
        min: 10, max: 900, step: 10, value: 100,
        ticksFrequency: 50,
        showRange: true,
        tooltip: true
