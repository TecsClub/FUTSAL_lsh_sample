...
-->
	    ...
	    <script type="text/javascript" src="<?php echo $THIS_SERVER_URL; ?>/WEBAPPS/LIBS/jqw/jqwidgets/jqxtabs.js"></script>
	    <script type="text/javascript" src="<?php echo $THIS_SERVER_URL; ?>/WEBAPPS/LIBS/jqw/jqwidgets/jqxdragdrop.js"></script>
