...
-->
	    ...
	    <script src="/WEBAPPS/LIBS/dateformat.js"></script>
			...
			<!-- donghee source script -->
			<script type="text/javascript" src="/WEBAPPS/APPS/3DPMIC/assets/js/jquery.fullPage.js"></script>
			<script type="text/javascript" src="/WEBAPPS/APPS/3DPMIC/assets/js/swiper.min.js"></script>
		<script>
