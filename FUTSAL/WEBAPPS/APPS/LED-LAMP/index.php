<?php
	...
	$INDEX_SLASH = strrpos($_SERVER['REQUEST_URI'], "/");
	$APP_NAME = substr($_SERVER["REQUEST_URI"], 0, $INDEX_SLASH);
	$INDEX_SLASH = strrpos($APP_NAME, "/");
	$APP_NAME = substr($APP_NAME, $INDEX_SLASH + 1);

//	error_log("THIS_SERVER_URL => " . $THIS_SERVER_URL);
//	error_log("APP_NAME => " . $APP_NAME);
?>			
<html>
	<head>
		<meta charset="utf-8">
...
-->
	    <!-- ionic script ionic/angularjs js -->
<!--
...
-->
	    ...
	    <script src="<?php echo $THIS_SERVER_URL; ?>/WEBAPPS/LIBS/formatDate.js"></script>
